...
## Status
Milníky **M1–M7 hotové**, **M8+ průběžně**. **Jediná scéna** — dioráma s **4-vrstvou taxonomií** (DD-25 sez. 16: Bloky / Voxely / Linie / Objekty). Po sez. 17–18 tři nové DD: **DD-26 sjednocená `ORIENTATION`** napříč BLOCKS i COMPOSITES (float [0, 360) ve stupních), **DD-27 PATH** (1. potomek vrstvy 3 LINES, Catmull-Rom strip), **DD-28 sjednocená Y konvence** (BLOCKS = grid-center, surface třídy = mesh bottom).
