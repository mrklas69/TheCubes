...
Canonical terminologie projektu TheCubes. Stav po sez. 35 (DD-32 terrain sandbox pivot, DD-33 ramp smoothing layer, DD-34 orientation mapping centralizace, DD-35 TDRAMP class, DD-36 TCUBES atlas pipeline *(superseded DD-41)*, DD-37 InstancedMesh batch pipeline, DD-38 WORLD re-introduce s DAY/DAY_SPEED *(sun position math superseded DD-43)*, DD-39 atmospheric lerping, DD-40 LAMP/SpotLight pattern, DD-41 lowpoly vertex-color pipeline, DD-42 G2 Climate WORLD LATITUDE×HUMIDITY + sun tilt driver, DD-43 DAY mapping standardizace 0.5=poledne). Smazané třídy a koncepty (FACILITY rodina + factory toy, severská dioráma s pixel-voxel COMPOSITES, VOXEL_MODEL infrastruktura) žijí v immutable diary jako historický kontext — zde se neuvádějí.
